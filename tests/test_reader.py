...
def test_get_dict_from_file_json() -> None:
    ...
    result: dict = reader.get_dict_from_file(
        "/home/user/PycharmProjects/jsonvalidator/tests/test_data/event/1eba2aa1-2acf-460d-91e6-55a8c3e3b7a3.json")
...
def test_get_dict_from_dict_scheme() -> None:
    reader: Reader = Reader()
    result: dict = reader.get_dict_from_file(
        "/home/user/PycharmProjects/jsonvalidator/tests/test_data/schema/cmarker_created.schema")
